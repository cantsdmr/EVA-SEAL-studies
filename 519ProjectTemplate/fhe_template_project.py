...
if __name__ == "__main__":
    ...
    avgCompiletimes, avgKeygenerationtimes, avgEncryptiontimes, avgExecutiontimes, avgDecryptiontimes, avgReferenceexecutiontimes, avgMses = [],[],[],[],[],[],[]
    medianCompiletimes, medianKeygenerationtimes, medianEncryptiontimes, medianExecutiontimes, medianDecryptiontimes, medianReferenceexecutiontimes, medianMses = [],[],[],[],[],[],[]
    nodeCounts = []
    ...
    for nc in range(36,64,4): # Node counts for experimenting various graph sizes
        ...
        compiletimes, keygenerationtimes, encryptiontimes, executiontimes, decryptiontimes, referenceexecutiontimes, mses = [],[],[],[],[],[],[]      
        for i in range(simcnt):
            ...
            keygenerationtimes.append(keygenerationtime)
            encryptiontimes.append(encryptiontime)
            executiontimes.append(executiontime)
            decryptiontimes.append(decryptiontime)
            referenceexecutiontimes.append(referenceexecutiontime)
            mses.append(mse)

            res = str(n) + "," + str(i+1) + "," + str(compiletime) + "," + str(keygenerationtime) + "," +  str(encryptiontime) + "," +  str(executiontime) + "," +  str(decryptiontime) + "," +  str(referenceexecutiontime) + "," +  str(mse) + "\n"
            print(res)
            resultfile.write(res)

        avgCompiletimes.append(statistics.mean(compiletimes))
        avgKeygenerationtimes.append(statistics.mean(keygenerationtimes))
        avgEncryptiontimes.append(statistics.mean(encryptiontimes))
        avgExecutiontimes.append(statistics.mean(executiontimes))
        avgDecryptiontimes.append(statistics.mean(decryptiontimes))
        avgReferenceexecutiontimes.append(statistics.mean(referenceexecutiontimes))
        avgMses.append(statistics.mean(mses))

        medianCompiletimes.append(statistics.median(compiletimes))
        medianKeygenerationtimes.append(statistics.median(keygenerationtimes))
        medianEncryptiontimes.append(statistics.median(encryptiontimes))
        medianExecutiontimes.append(statistics.median(executiontimes))
        medianDecryptiontimes.append(statistics.median(decryptiontimes))
        medianReferenceexecutiontimes.append(statistics.median(referenceexecutiontimes))
        medianMses.append(statistics.median(mses))

        resultfile.close()

    plotGraph(nodeCounts, avgCompiletimes, "Node Count", "Compile Time - Average", "Node Count vs Compile Time - Average")
    plotGraph(nodeCounts, avgKeygenerationtimes, "Node Count", "Key Generation Time - Average", "Node Count vs Key Generation Time - Average")
    plotGraph(nodeCounts, avgEncryptiontimes, "Node Count", "Encryption Time - Average", "Node Count vs Encryption Time - Average")
    plotGraph(nodeCounts, avgExecutiontimes, "Node Count", "Execution Time - Average", "Node Count vs Execution Time - Average")
    plotGraph(nodeCounts, avgDecryptiontimes, "Node Count", "Decryption Time - Average", "Node Count vs Decryption Time - Average")
    plotGraph(nodeCounts, avgReferenceexecutiontimes, "Node Count", "Reference Execution Time - Average", "Node Count vs Reference Execution Time - Average")
    plotGraph(nodeCounts, avgMses, "Node Count", "MSE - Average", "Node Count vs MSE - Average")

    plotGraph(nodeCounts, medianCompiletimes, "Node Count", "Compile Time - Median", "Node Count vs Compile Time - Median")
    plotGraph(nodeCounts, medianKeygenerationtimes, "Node Count", "Key Generation Time - Median", "Node Count vs ey Generation Time  - Median")
    plotGraph(nodeCounts, medianEncryptiontimes, "Node Count", "Encryption Time - Median", "Node Count vs Encryption Time - Median")
    plotGraph(nodeCounts, medianExecutiontimes, "Node Count", "Execution Time - Median", "Node Count vs Execution Time - Median")
    plotGraph(nodeCounts, medianDecryptiontimes, "Node Count", "Decryption Time - Median", "Node Count vs Decryption Time - Median")
    plotGraph(nodeCounts, medianReferenceexecutiontimes, "Node Count", "Reference Execution Time - Median", "Node Count vs Reference Execution Time - Median")
    plotGraph(nodeCounts, medianMses, "Node Count", "MSE - Median", "Node Count vs MSE - Median")